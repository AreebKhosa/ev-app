...
import { ArrowUpRight, Zap, Gauge, BatteryCharging } from "lucide-react";
...
const DEFAULT_CATEGORIES: CategoryItem[] = [
  {
    ...
    badge: "City & Commute",
    title: "Urban Glide",
    subtitle: "Lightweight & Agile",
    description: "Engineered for effortless daily city commute with stealth integrated battery and smart anti-theft telemetry.",
    image: "https://images.unsplash.com/photo-1485965120184-e220f721d03e?q=80&w=900&auto=format&fit=crop",
    href: "/products",
    specs: [
      { icon: <Gauge className="w-3.5 h-3.5" />, label: "Top Speed", value: "45 km/h" },
      { icon: <BatteryCharging className="w-3.5 h-3.5" />, label: "Range", value: "85 km" },
      { icon: <Zap className="w-3.5 h-3.5" />, label: "Motor", value: "500W Hub" },
    ],
  },
  {
    id: "offroad-series",
    ...
    title: "Apex Beast",
    subtitle: "Dual Suspension Power",
    description: "Built to conquer mountain peaks, rocky paths, and sand trails with massive puncture-proof fat tires and dual torque.",
    image: "https://images.unsplash.com/photo-1571068316344-75bc76f77890?q=80&w=900&auto=format&fit=crop",
    href: "/products",
    specs: [
      { icon: <Gauge className="w-3.5 h-3.5" />, label: "Top Speed", value: "65 km/h" },
      { icon: <BatteryCharging className="w-3.5 h-3.5" />, label: "Range", value: "120 km" },
      { icon: <Zap className="w-3.5 h-3.5" />, label: "Motor", value: "1000W Dual" },
    ],
  },
];
...
export function CategorySection({
  tag = "Product Lineup",
  heading = "Choose Your Riding Style",
  subheading = "Two distinct platforms tailored for precision city cruising or relentless mountain exploration.",
          ...
          >
            ...
            <div className="space-y-4 relative z-10">
              <div className="flex items-center justify-between">
                ...
                <Link
                  href={cat.href}
                  className="w-10 h-10 rounded-full bg-neutral-900 dark:bg-white text-white dark:text-black flex items-center justify-center group-hover:bg-[#D4FF00] group-hover:text-black transition-colors duration-300 shadow-md"
              ...
              <div>
                <h3 className="text-3xl md:text-4xl font-black tracking-tight text-neutral-900 dark:text-white group-hover:text-[#92b500] dark:group-hover:text-[#D4FF00] transition-colors">
                  {cat.title}
                </h3>
            ...
            <div className="relative w-full aspect-[16/10] my-6 flex items-center justify-center overflow-hidden rounded-2xl">
              <Image
                src={cat.image}
                alt={cat.title}
                fill
            ...
            <div className="pt-4 border-t border-black/5 dark:border-white/10 relative z-10 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <Link
                href={cat.href}
                className="w-full sm:w-auto text-center px-5 py-2.5 rounded-xl bg-neutral-950 text-white dark:bg-white dark:text-black font-semibold text-xs hover:bg-[#D4FF00] hover:text-black dark:hover:bg-[#D4FF00] dark:hover:text-black transition-all duration-300 shadow-md whitespace-nowrap"
              >
                View Model
              </Link>
            </div>
